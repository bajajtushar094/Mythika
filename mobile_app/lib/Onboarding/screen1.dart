                      ...
                      children: [
                        Container(
                            ...
                            child: Align(
                              ...
                              child: Text("Learn more about yourself,", style: TextStyle(color: appPalette.brightRose, fontSize: 24, decoration: TextDecoration.none, fontWeight: FontWeight.w900)),
                            )
                        )
                      ]),
                  Row(//ROW 2
                      children: [
                        Container(
                            ...
                            child: Align(
                              ...
                              child: Text("Journal your health, mood & thoughts daily", style: TextStyle(color: appPalette.brightRose, fontSize: 18, decoration: TextDecoration.none, fontWeight: FontWeight.w600)),
                            )
                        )
                      ]),
                  Row(// ROW 3
