            ...
            child: Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/images/gynecology.png"),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                      ...
                      children: [
                        Container(
                            ...
                            child: Align(
                              ...
                              child: Text("Get help of professionals", style: TextStyle(color: appPalette.brightRose, fontSize: 24, decoration: TextDecoration.none, fontWeight: FontWeight.w900)),
                            )
                        )
                      ]),
                  Row(//ROW 2
                      children: [
                        Container(
                            ...
                            child: Align(
                              alignment: Alignment.center,
                              child: Text("Convert your daily journal into reports", style: TextStyle(color: appPalette.brightRose, fontSize: 18, decoration: TextDecoration.none, fontWeight: FontWeight.w600)),
                            )
                        )
                      ]),
                  Row(// ROW 3
